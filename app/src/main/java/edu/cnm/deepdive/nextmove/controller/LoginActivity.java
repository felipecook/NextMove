...
/*
This class functions as a login screen for my application. This inflates the intro screen which
includes the google sign in. It should also include my background picture for my application along
with version ID and my developer name.
 */
